...
:root {
  /* Updated color tokens to use blue primary (#0384c7) and gray-white palette */
  --background: oklch(1 0 0); /* Pure white */
  --foreground: oklch(0.3 0 0); /* Dark gray */
  --card: oklch(0.98 0 0); /* Light gray-white */
  --card-foreground: oklch(0.3 0 0);
  --popover: oklch(1 0 0);
  --popover-foreground: oklch(0.3 0 0);
  --primary: oklch(0.55 0.15 240); /* Blue #0384c7 equivalent */
  --primary-foreground: oklch(1 0 0);
  --secondary: oklch(0.95 0 0); /* Light gray */
  --secondary-foreground: oklch(0.3 0 0);
  --muted: oklch(0.96 0 0); /* Very light gray */
  --muted-foreground: oklch(0.4 0 0); /* Darker gray for better contrast */
  --accent: oklch(0.55 0.15 240); /* Blue accent matching primary */
  ...
  --sidebar-primary-foreground: oklch(0.3 0 0);
...
.dark {
  ...
  --primary: oklch(0.6 0.18 240); /* Brighter blue for dark mode */
